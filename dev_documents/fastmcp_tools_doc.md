...
<CodeGroup>
  ...
  ```json Traditional Content theme={null}
  "{\n  \"name\": \"Alice\",\n  \"age\": 30,\n  \"active\": true\n}"
  ```

  ```json Structured Content (Automatic) theme={null}
  {
    "name": "Alice", 
    "age": 30,
    "active": true
...
<CodeGroup>
  ...
  ```json Traditional Content Only theme={null}
  "8"
  ```

  ```python Integer Return (With Schema) theme={null}
  @mcp.tool
  ...
  ```json Structured Content (From Schema) theme={null}
  {
    "result": 8
  }
  ```
...
<CodeGroup>
  ...
  ```json Structured Output theme={null}
  {
    "name": "Alice",
    "age": 30,
...
<CodeGroup>
  ...
  ```json Generated Schema (Wrapped) theme={null}
  {
    "type": "object",
    "properties": {
      "result": {"type": "integer"}
